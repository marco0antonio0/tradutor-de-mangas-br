    ...
    <div className="max-w-2xl mx-auto space-y-6 py-2">
      ...
      <Card className="p-5 space-y-4">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          usado opcionalmente na etapa de tradução de texto. Nenhum arquivo, conta ou histórico
          é enviado para servidores próprios — tudo fica salvo no seu disco.
        </p>
      </Card>
      ...
      <Card className="p-5 space-y-3">
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          <li className="flex items-start gap-2">
            ...
            Banco de dados, imagens, OCR e traduções ficam armazenados no diretório local
            da instância.
          </li>
          <li className="flex items-start gap-2">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
          ...
          <li className="flex items-start gap-2">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
            A única comunicação externa é a tradução de texto via Google Tradutor — só os
            trechos de texto extraídos são enviados, sem identificação de usuário.
          </li>
        </ul>
      </Card>
